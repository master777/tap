...
<div id="mostrartermi" style="display:block">
               ...
               <div style="display:inline-block"><p style="font-size:12px">TERMINALES Y CENTRALES</p>
                <p style="color:#1959A0;font-weight:bold">ZACATECAS</p></div>
            </div>
...
<div id="mostraragencias" style="display:none;">
            <div style="display:inline-block;text-align:left;font-family: 'raleway'">
            ...
            <center><table>
                  ...
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: VIAJES HERMAN SUC 1</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">JALPA</td>
                        <td class="rellenotabla">CENTRO</td>
                        <td class="rellenotabla2">PLAZA ARECHIGA N-39</td>
                        <td class="rellenotabla">4639552872</td>
                        <td class="rellenotabla">4639552376</td>
                  </tr>
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: VIAJES HERMAN MTZ</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">JUCHIPILA</td>
                        <td class="rellenotabla">CENTRO</td>
                        <td class="rellenotabla2">ZARAGOZA N.-24</td>
                        <td class="rellenotabla">4679520092</td>
                        <td class="rellenotabla">4679520250</td>
                  </tr>
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: VIAJES HERMAN SUC 2</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">NOCHISTLAN</td>
                        <td class="rellenotabla">CENTRO</td>
                        <td class="rellenotabla2">ESPARZA QUEZADA N.-7B</td>
                        <td class="rellenotabla">3467130276</td>
                        <td class="rellenotabla">3467130344</td>
                  </tr>
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: VIAJES HERMAN SUC. 3</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">TEOCALTICHE</td>
                        <td class="rellenotabla">CENTRO</td>
                        <td class="rellenotabla2">HIDALGO N.-249</td>
                        <td class="rellenotabla">3467872404</td>
                        <td class="rellenotabla">3467872405</td>
                  </tr>
...
<div id="mostraroxxo" style="display:none">
            ...
            <p style="font-family: 'raleway';">Adquiere tus boletos de autobus TAP en las tiendas Oxxo.</p>
