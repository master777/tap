...
<div id="mostrartermi" style="display:block">
      ...
      <div style="display:inline-block;text-align:left;font-family: 'helvetica','raleway'">
               ...
               <div style="display:inline-block"><p style="font-size:12px">TERMINALES Y CENTRALES</p>
                <p style="color:#1959A0;font-weight:bold">SAN LUIS POTOSÍ</p></div>
            </div>
...
<div id="mostraragencias" style="display:none">
            ...
            <center><table>
                  ...
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: ELITE TRAVELERS</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">SAN LUIS POTOSI</td>
                        <td class="rellenotabla">BARRIO DE TEQUISQUIAPAN</td>
                        <td class="rellenotabla2">MARIANO OTERO 626</td>
                        <td class="rellenotabla">4448333452</td>
                        <td class="rellenotabla">4448333451</td>
                  </tr>
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: AGENCIA DE VIAJES ANDARES</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">SAN LUIS POTOSI</td>
                        <td class="rellenotabla">CENTRO</td>
                        <td class="rellenotabla2">5 DE MAYO 720 INT 1</td>
                        <td class="rellenotabla">4448141902</td>
                        <td class="rellenotabla"></td>
                  </tr>
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: ENLACE VIAJES Y HOTELES</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">SAN LUIS POTOSI</td>
                        <td class="rellenotabla">TEQUIS</td>
                        <td class="rellenotabla2">AV NICOLAS ZAPATA N 876 LOC 6</td>
                        <td class="rellenotabla">4448331980</td>
                        <td class="rellenotabla">4448330501</td>
                  </tr>
