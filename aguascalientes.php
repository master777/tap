...
<div id="mostrartermi" style="display:block">
      ...
      <div style="display:inline-block;text-align:left;font-family: 'helvetica','raleway'">
               ...
               <div style="display:inline-block"><p style="font-size:12px">TERMINALES Y CENTRALES</p>
                <p style="color:#1959A0;font-weight:bold">AGUASCALIENTES</p></div>
            </div>
...
<div id="mostraragencias" style="display:none">
            ...
            <center><table>
                  ...
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: SIAN KA'AN VIAJES</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">AGUASCALIENTES</td>
                        <td class="rellenotabla">PILAR BLANCO INFONAVIT</td>
                        <td class="rellenotabla2">PASEO DE LA ASUNCION N 1132</td>
                        <td class="rellenotabla">4491622261</td>
                        <td class="rellenotabla">4491622262</td>
                  </tr>
