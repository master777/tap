...
<div id="mostrartermi" style="display:block">
      ...
      <div style="display:inline-block;text-align:left;font-family: 'helvetica','raleway'">
               ...
               <div style="display:inline-block"><p style="font-size:12px">TERMINALES Y CENTRALES</p>
                <p style="color:#1959A0;font-weight:bold">COLIMA</p></div>
            </div>
...
<div id="mostraragencias" style="display:none">
            ...
            <center><table>
                  ...
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: TICKET PACK</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">COLIMA</td>
                        <td class="rellenotabla">JARDINES RESIDENCIALES</td>
                        <td class="rellenotabla2">PASO DE LOS JARDINES 240</td>
                        <td class="rellenotabla">3123146214</td>
                        <td class="rellenotabla">3123144845</td>
                  </tr>
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: ACUARIO TURISTICO</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">MANZANILLO</td>
                        <td class="rellenotabla">CENTRO</td>
                        <td class="rellenotabla2">AV MEXICO 207</td>
                        <td class="rellenotabla">3143324577</td>
                        <td class="rellenotabla">3143324532</td>
                  </tr>
