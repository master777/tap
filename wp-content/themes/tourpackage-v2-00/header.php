...
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/stylesheet/edward.css?version=<?php echo time()?>"><br>
<script type='text/javascript' src='<?php bloginfo('template_directory'); ?>/javascript/edward.js'></script> 
				...
				<div class="header-wrapper boxed-style">
					<div class="header-container container">
						...
						<div class="logo-wrapper">
                            ...
                            <!-- texto logo 
                            <p style="font-size: 11px;">El mejor transporte del pacífico</p>
                            <!-- texto logo -->
						...
						echo '<div class="chat">
								<a href="">
									<img src="http://sipyme.mx/tap/wp-content/uploads/2015/02/chat-logo1.png">
								</a>
							  </div>
								';
