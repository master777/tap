...
<div id="mostrartermi" style="display:block">
      ...
      <div style="display:inline-block;text-align:left;font-family: 'helvetica','raleway'">
               ...
               <div style="display:inline-block"><p style="font-size:12px">TERMINALES Y CENTRALES</p>
                <p style="color:#1959A0;font-weight:bold">HIDALGO</p></div>
            </div>
...
<div id="mostraragencias" style="display:none">
            ...
            <center><table>
                  ...
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: PROMOTORA TURISTICA VAGABUNDO</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">TEPEAPULCO</td>
                        <td class="rellenotabla">PLAZA VIEJA</td>
                        <td class="rellenotabla2">INDEPENDENCIA N 17</td>
                        <td class="rellenotabla">7919137355</td>
                        <td class="rellenotabla">7919131765</td>
                  </tr>
