...
<div id="mostrartermi" style="display:block">
      ...
      <div style="display:inline-block;text-align:left;font-family: 'helvetica','raleway'">
               ...
               <div style="display:inline-block"><p style="font-size:12px">TERMINALES Y CENTRALES</p>
                <p style="color:#1959A0;font-weight:bold">GUANAJUATO</p></div>
            </div>
...
<div id="mostraragencias" style="display:none">
            ...
            <center><table>
                  ...
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: MUNDO VIAJERO</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">IRAPUATO</td>
                        <td class="rellenotabla">LAS REYNAS</td>
                        <td class="rellenotabla2">BLDV DEL BOSQUE N 1 LOC 8</td>
                        <td class="rellenotabla">4626351681</td>
                        <td class="rellenotabla"></td>
                  </tr>
                  <tr>
                        <td class="textocolspan" colspan="5">Agencia: VIAJES HCELENE</td>
                  </tr>
                  <tr>
                        <td class="rellenotabla">PENJAMO</td>
                        <td class="rellenotabla">CENTRO</td>
                        <td class="rellenotabla2">HIDALGO Y ALDAMA S/N</td>
                        <td class="rellenotabla">4696920051</td>
                        <td class="rellenotabla">4696923430</td>
                  </tr>
